...
<head>
	...
	->lessInit()->setLessVariables(array(
		...
		'header_bg'=> $this->helix3->PresetParam('_header_bg'),
		'footer_bg'=> $this->helix3->PresetParam('_footer_bg')
		))
...
<body>
			...
			<div class="container">
				<div class="text-center">
					<div id="sp-comingsoon">
						...
						<div id="countdown-timer"><!--Placeholder--></div>
	...
	jQuery(function($) {
		$("#countdown-timer").countdown('<?php echo trim($comingsoon_date[2]); ?>/<?php echo trim($comingsoon_date[1]); ?>/<?php echo trim($comingsoon_date[0]); ?>', function(event) {
			$(this).html(event.strftime('<span class="timer-day">%D<span>%!D:<?php echo JText::_("HELIX_DAY"); ?>,<?php echo JText::_("HELIX_DAYS"); ?>;</span></span><span class="timer-hour">%H<span>%!H:<?php echo JText::_("HELIX_HOUR"); ?>,<?php echo JText::_("HELIX_HOURS"); ?>;</span></span><span class="timer-minute">%M<span>%!M:<?php echo JText::_("HELIX_MINUTE"); ?>,<?php echo JText::_("HELIX_MINUTES"); ?>;</span></span><span class="timer-second">%S<span>%!S:<?php echo JText::_("HELIX_SECOND"); ?>,<?php echo JText::_("HELIX_SECONDS"); ?>;</span></span>'));
		});
	});
