...
class Helix3FeatureFooter {
	...
	public function renderFeature() {
		...
		if($this->helix3->getParam('enabled_copyright')) {
			...
			if($this->helix3->getParam('footer_logo')) $output .= '<a href="' . JURI::base(true) . '/"><img class="sp-footer-logo" src="'. $this->helix3->getParam('footer_logo') .'" alt="'. JFactory::getApplication()->get('sitename') .'"></a>';
