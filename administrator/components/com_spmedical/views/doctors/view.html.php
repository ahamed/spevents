...
class SpmedicalViewDoctors extends JViewLegacy {
	...
	function display($tpl = null){
		...
		// Set the submenu
		SpmedicalHelper::addSubmenu('doctors');
		$this->addToolBar();
	...
	protected function addToolBar() {
		JToolBarHelper::title(JText::_('COM_SPMEDICAL_PAGE_HEADING') .  JText::_('COM_SPMEDICAL_DOCTORS'));
		...
		if ($this->canDo->get('core.edit.state')) {
			JToolbarHelper::publish('doctors.publish', 'JTOOLBAR_PUBLISH', true);
			JToolbarHelper::unpublish('doctors.unpublish', 'JTOOLBAR_UNPUBLISH', true);
			JToolbarHelper::archiveList('doctors.archive');
			JToolbarHelper::checkin('doctors.checkin');
		}

		if ($this->state->get('filter.published') == -2 && $this->canDo->get('core.delete')) {
			JToolbarHelper::deleteList('', 'doctors.delete', 'JTOOLBAR_EMPTY_TRASH');
