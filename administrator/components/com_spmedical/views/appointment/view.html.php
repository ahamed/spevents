...
class SpmedicalViewAppointment extends JViewLegacy {
	...
	protected function addToolBar() {
		...
		JToolBarHelper::title(JText::_('COM_SPMEDICAL_APPOINTMENT') . ': '.  ($isNew ? JText::_('COM_SPMEDICAL_NEW') : JText::_('COM_SPMEDICAL_EDIT')), 'pencil');

		if ($isNew) {
			// For new records, check the create permission.
			if ($this->canDo->get('core.create')) {
				JToolBarHelper::apply('appointment.apply', 'JTOOLBAR_APPLY');
				JToolBarHelper::save('appointment.save', 'JTOOLBAR_SAVE');
			}
