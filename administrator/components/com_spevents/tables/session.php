...
class SpeventsTableSession extends JTable
{
	public function __construct(&$db)
	{
		parent::__construct('#__spevents_sessions','id',$db);
	}

	public function bind($src, $ignore = array())
	{
		if (isset($src['speakers']) && is_array($src['speakers']))
		{
			$registry = new JRegistry();
			$registry->loadArray($src['speakers']);
			$src['speakers'] = (string)$registry;
		}
