...
class SpeventsTableSpeaker extends JTable
{
	public function __construct(&$db)
	{
		parent::__construct('#__spevents_speakers','id',$db);
	}

	public function bind($src, $ignore = array())
	{
		if (isset($src['social_links']) && is_array($src['social_links']))
		{
			$registry = new JRegistry();
			$registry->loadArray($src['social_links']);
			$src['social_links'] = (string)$registry;
		}
	...
	public function store($updateNulls = false)
	{
		...
		$table = JTable::getInstance('Speaker','SpeventsTable');
