...
(function ($) {
  ...
  * ======================================================================== */
  ...
  $.fn.browseMedia = function(options) {
    ...
    $.ajax({
      type : 'POST',
      url: 'index.php?option=com_spevents&view=media&layout=browse&format=json',
  ...
  * ======================================================================== */
  ...
  $.fn.browseFolders = function(options) {
    ...
    return this.each(function() {
      $.ajax({
        url: 'index.php?option=com_spevents&view=media&layout=folders&format=json',
        type   : 'POST',
  ...
  * ======================================================================== */
  ...
  $.fn.uploadMedia = function(options) {
    ...
    $.ajax({
      type: "POST",
      url: 'index.php?option=com_spevents&task=media.upload_media',
      data: options.data,
      contentType: false,
      cache: false,
      processData:false,
  ...
  * ======================================================================== */
  ...
  $(document).on('click', '#sp-media-modal .btn-delete-media', function(event) {
    ...
    if (confirm(Joomla.JText._('SPMEDIA_MANAGER_CONFIRM_DELETE')) == true) {
      $.ajax({
        type: "POST",
        url: 'index.php?option=com_spevents&task=media.delete_media',
