...
if($saveOrder) {
	$saveOrderingUrl = 'index.php?option=com_spevents&task=locations.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_spevents&view=locations'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container" class="span10" >
		...
		<table class="table table-striped" id="eventList">
			...
			<tr>
				...
				<th>
					<?php echo JHtml::_('grid.sort','COM_SPEVENTS_VENUE_LABEL','a.venue_name',$listDirn,$listOrder); ?>
				</th>

				<th>
					<?php echo JHtml::_('grid.sort', 'COM_SPEVENTS_ADDRESS_LABEL', 'a.address', $listDirn, $listOrder); ?>
				</th>
				<th>
					<?php echo JHtml::_('grid.sort', 'COM_SPEVENTS_COUNTRY_LABEL', 'a.country', $listDirn, $listOrder); ?>
				</th>
				<th>
					<?php echo JHtml::_('grid.sort', 'COM_SPEVENTS_CITY_LABEL', 'a.city', $listDirn, $listOrder); ?>
				</th>
				<th>
			...
			<?php foreach($this->items as $i => $item): ?>
				...
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
					...
					<td>
						...
						<?php if ($canEdit) : ?>
							<a class="sp-events-title" href="<?php echo JRoute::_('index.php?option=com_spevents&task=location.edit&id=' . $item->id);?>">
								<?php echo $this->escape($item->venue_name); ?>
							</a>
						<?php else : ?>
							<?php echo $this->escape($item->venue_name); ?>
						<?php endif; ?>
					...
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->enabled, $i, 'locations.', true,'cb');?>
					</td>
