...
class SpeventsViewLocations extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		$this->model = $this->getModel('locations');

//		/SpeventsHelper::___($this->items);

		SpeventsHelper::addSubmenu('locations');
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_SPEVENTS_LOCATIONS_TITLE_LABEL'), 'location');
	}
