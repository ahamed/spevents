...
if($saveOrder) {
	$saveOrderingUrl = 'index.php?option=com_spevents&task=tickets.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_spevents&view=tickets'); ?>" method="POST" name="adminForm" id="adminForm">
	...
	<div id="j-main-container" class="span10" >
		...
		<?php echo "<pre class='center'><code>No ticket</code></pre>"; ?>
		<?php else: ?>
		<table class="table table-striped" id="eventList">
			...
			<tr>
				...
				<th width="1%" class="nowrap center">
					<?php echo JHtml::_('grid.sort', 'JSTATUS', 'a.price', $listDirn, $listOrder); ?>
				</th>
				<th width="1%" class="nowrap center">
					<?php echo JHtml::_('grid.sort', 'JSTATUS', 'a.seat', $listDirn, $listOrder); ?>
				</th>
			...
			<?php foreach($this->items as $i => $item): ?>
				...
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
					...
					<td>
						...
						<?php if ($canEdit) : ?>
							<a class="sp-events-title" href="<?php echo JRoute::_('index.php?option=com_spevents&task=ticket.edit&id='.$item->id);?>">
					...
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->enabled, $i, 'tickets.', true,'cb');?>
					</td>
