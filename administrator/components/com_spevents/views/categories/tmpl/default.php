...
if($saveOrder) {
	$saveOrderingUrl = 'index.php?option=com_spevents&task=categories.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_spevents&view=categories'); ?>" method="POST" name="adminForm" id="adminForm">
		...
		<table class="table table-striped" id="eventList">
			...
			<?php foreach($this->items as $i => $item): ?>
				...
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
					...
					<td>
						<img src="<?php echo JURI::root(true) . '/' . $item->image; ?>" alt="" style="width: 64px; height: auto; border: 1px solid #e5e5e5; background-color: #f5f5f5;">
					</td>
					<td>
						...
						<?php if ($canEdit) : ?>
							<a class="sp-events-title" href="<?php echo JRoute::_('index.php?option=com_spevents&task=category.edit&id='.$item->id);?>">
