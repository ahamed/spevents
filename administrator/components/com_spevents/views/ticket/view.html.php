...
class SpeventsViewTicket extends JViewLegacy
{
	protected $item;
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_("COM_SPEVENTS_TICKET_" . ($isNew ? 'NEW' : 'EDIT')), 'tag');

		if ($canDo->get('core.edit'))
		{
			JToolbarHelper::apply('ticket.apply','JTOOLBAR_APPLY');
			JToolbarHelper::save('ticket.save','JTOOLBAR_SAVE');
			JToolbarHelper::save2new('ticket.save2new');
			JToolbarHelper::save2copy('ticket.save2copy');
		}
