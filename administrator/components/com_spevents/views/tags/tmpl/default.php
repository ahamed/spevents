...
if($saveOrder) {
	$saveOrderingUrl = 'index.php?option=com_spevents&task=tags.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_spevents&view=tags'); ?>" method="POST" name="adminForm" id="adminForm">
			...
			<?php foreach($this->items as $i => $item): ?>
				...
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
					...
					<td>
						...
						<?php if ($canEdit) : ?>
							<a class="sp-events-title" href="<?php echo JRoute::_('index.php?option=com_spevents&task=tag.edit&id='.$item->id);?>">
