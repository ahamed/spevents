...
class SpeventsViewTags extends JViewLegacy
{
	protected $items;
...
//		/SpeventsHelper::___($this->items);
		...
		SpeventsHelper::addSubmenu('tags');
	...
	protected function addToolbar()
	{
		...
		JHtmlSidebar::setAction('index.php?option=com_spevents&view=tags');
		...
		JToolbarHelper::title(JText::_('COM_SPEVENTS_TAGS_TITLE_LABEL'), 'tags');
	}
