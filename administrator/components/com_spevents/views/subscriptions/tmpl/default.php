...
if($saveOrder) {
	$saveOrderingUrl = 'index.php?option=com_spevents&task=subscriptions.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_spevents&view=subscriptions'); ?>" method="POST" name="adminForm" id="adminForm">
