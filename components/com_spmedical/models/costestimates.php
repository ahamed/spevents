...
class SpmedicalModelCostestimates extends JModelList {
	...
	public static function getDepartmentServieces() {
		$db = JFactory::getDbo();
		$query = $db->getQuery(true);
		// Order it by the ordering field.
		$query->select($db->quoteName(array('id', 'title', 'alias', 'treatments', 'investigations', 'others_services')));
