...
class SpmedicalModelSpecialist extends JModelItem {

	protected $_context = 'com_spmedical.specialist';

	protected function populateState() {
		$app = JFactory::getApplication('site');
		$itemId = $app->input->getInt('id');
		$this->setState('specialist.id', $itemId);
	...
	public function getItem( $itemId = null ) {
		...
		$itemId = (!empty($itemId))? $itemId : (int)$this->getState('specialist.id');
