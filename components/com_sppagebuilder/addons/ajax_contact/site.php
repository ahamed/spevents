            ...
            $output .= '<form class="sppb-ajaxt-contact-form">';
                ...
                if ($show_checkbox) {
                    $output .='<div class="sppb-form-group">';
                        ...
                        $output .='<input class="sppb-form-check-input" type="checkbox" id="tac" required="required">';
                        $output .='<label class="sppb-form-check-label" for="tac">' . $checkbox_title  . '</label>';
                        $output .='</div>';
                    $output .='</div>';
                }
			...
			<div class="sppb-ajax-contact-content">
				<form class="sppb-ajaxt-contact-form">
                    ...
                    <# if(data.formcaptcha && data.captcha_type == "gcaptcha"){ #>
                        <div class="row">
                            <div class="sppb-form-group col-sm-12">
                        ...
                        <div class="row">
                            <div class="sppb-form-group col-sm-12">
                                <div class="sppb-form-check">
                                    <input class="sppb-form-check-input" type="checkbox" id="tac" required="required">
                                    <label class="sppb-form-check-label" for="tac">{{{ data.checkbox_title }}}</label>
                                </div>
                            </div>
                        </div>
					<# } 
